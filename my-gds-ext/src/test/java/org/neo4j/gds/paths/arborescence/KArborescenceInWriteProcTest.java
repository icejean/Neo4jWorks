...
public class KArborescenceInWriteProcTest extends BaseProcTest5x {
    ...
    void setupGraph() throws Exception {
        registerProcedures(KArborescenceInWriteProc.class, GraphProjectProc.class);
