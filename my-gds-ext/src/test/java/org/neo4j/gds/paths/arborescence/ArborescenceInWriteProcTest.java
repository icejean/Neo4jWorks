...
class ArborescenceInWriteProcTest extends BaseProcTest5x {
    ...
    void setupGraph() throws Exception {
        registerProcedures(ArborescenceInWriteProc.class,  GraphProjectProc.class);
