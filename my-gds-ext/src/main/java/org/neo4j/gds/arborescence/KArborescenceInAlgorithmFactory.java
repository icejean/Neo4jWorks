...
public class KArborescenceInAlgorithmFactory<CONFIG extends KArborescenceConfig> extends GraphAlgorithmFactory<ZhuLiuInK, CONFIG> {

    @Override
    public ZhuLiuInK build(Graph graphOrGraphStore, CONFIG configuration, ProgressTracker progressTracker) {
    ...
    public Task progressTask(Graph graph, CONFIG config) {
        return Tasks.task(
                taskName(),
                Tasks.leaf("KArborescenceIn", graph.nodeCount()),
