...
public class ArborescenceOutAlgorithmFactory<CONFIG extends ArborescenceConfig> extends GraphAlgorithmFactory<ZhuLiuOut, CONFIG> {

    @Override
    public ZhuLiuOut build(Graph graphOrGraphStore, CONFIG configuration, ProgressTracker progressTracker) {
    ...
    public Task progressTask(Graph graph, CONFIG config) {
        return Tasks.task(
                taskName(),
                Tasks.leaf("ArborescenceOut", graph.nodeCount()),
