...
public class DirectedSpanningGraph extends SpanningGraph {
    ...
    public void forEachRelationship(long nodeId, double fallbackValue, RelationshipWithPropertyConsumer consumer) {
        ...
        if (parent >=0) {
        	...
        	// For directed graph's arborescence of in direction, need to reverse the direction, just as it is the fact.
            consumer.accept(nodeId, parent, spanningTree.costToParent(nodeId));
        }
    }
