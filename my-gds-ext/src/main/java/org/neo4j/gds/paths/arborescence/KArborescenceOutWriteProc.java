...
public class KArborescenceOutWriteProc extends BaseProc {

    static final String procedure = "gds.arborescence.out.k.write";

    static final String DESCRIPTION = "Custom algorithm";

    @Procedure(value = procedure, mode = WRITE)
    @Description(DESCRIPTION)
    public Stream<KArborescenceOutWriteResult> compute(
        @Name(value = "graphName") String graphName,
        @Name(value = "configuration", defaultValue = "{}") Map<String, Object> configuration
    ) {
        return new ProcedureExecutor<>(
            new KArborescenceOutWriteSpec(transactionContext()),
            executionContext()
