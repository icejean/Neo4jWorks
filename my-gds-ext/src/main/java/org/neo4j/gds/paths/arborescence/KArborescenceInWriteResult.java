...
public final class KArborescenceInWriteResult extends StatsResult {


    public final long writeMillis;
    public final long relationshipsWritten;

    public KArborescenceInWriteResult(
    ...
    public static class Builder extends AbstractResultBuilder<KArborescenceInWriteResult> {
        ...
        @Override
        public KArborescenceInWriteResult build() {
            return new KArborescenceInWriteResult(
                preProcessingMillis,
                computeMillis,
                writeMillis,
                effectiveNodeCount,
