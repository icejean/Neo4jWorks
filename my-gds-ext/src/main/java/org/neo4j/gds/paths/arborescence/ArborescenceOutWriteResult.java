...
public final class ArborescenceOutWriteResult extends StatsResult {


    public final long writeMillis;
    public final long relationshipsWritten;

    public ArborescenceOutWriteResult(
    ...
    public static class Builder extends AbstractResultBuilder<ArborescenceOutWriteResult> {
        ...
        @Override
        public ArborescenceOutWriteResult build() {
            return new ArborescenceOutWriteResult(
                preProcessingMillis,
                computeMillis,
                writeMillis,
                effectiveNodeCount,
