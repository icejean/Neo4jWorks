...
public final class ArborescenceInWriteResult extends StatsResult {


    public final long writeMillis;
    public final long relationshipsWritten;

    public ArborescenceInWriteResult(
    ...
    public static class Builder extends AbstractResultBuilder<ArborescenceInWriteResult> {
        ...
        @Override
        public ArborescenceInWriteResult build() {
            return new ArborescenceInWriteResult(
                preProcessingMillis,
                computeMillis,
                writeMillis,
                effectiveNodeCount,
