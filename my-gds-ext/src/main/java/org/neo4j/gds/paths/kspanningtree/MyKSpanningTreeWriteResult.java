...
public final class MyKSpanningTreeWriteResult extends StatsResult {


    public final long writeMillis;
    public final long relationshipsWritten;

    public MyKSpanningTreeWriteResult(
    ...
    public static class Builder extends AbstractResultBuilder<MyKSpanningTreeWriteResult> {
        ...
        @Override
        public MyKSpanningTreeWriteResult build() {
            return new MyKSpanningTreeWriteResult(
                preProcessingMillis,
                computeMillis,
                writeMillis,
                effectiveNodeCount,
